# Decisiones de diseño — Architecture Decision Records

Las decisiones técnicas significativas del proyecto se documentan aquí en formato ADR (Architecture Decision Record).
